...
OTH_ROUNDS = [
    {"puzzle": "oc20260727", "ai": True,  "ai_survey": True,  "gate": True,
     ...
     "intro": {"title": "Puzzle 1",
               "body": "An <strong>AI assistant</strong> will be available to help you for this round. This is your <strong>only chance</strong> to use it in this study.<br>You MUST engage with the assistant for <strong>5+ turns</strong>."}},
