...
TASK_PRINCIPLES = (
    "A participant was shown one real chat message that an earlier participant sent to an "
    "AI assistant during a Connect Four puzzle: 'What do you think would be the best move "
    "right now?'. They were asked: 'What would you change about how this person is using "
    "the assistant, so that they come away able to make this kind of decision "
    "themselves?'\n"
