...
class JudgeSuite(dspy.Module):
    def __init__(self, callbacks=None):
        ...
        # (LM, grader class) per model: fast Together models use Predict;
        # gpt-5.4-mini uses ChainOfThought (reasoning improves its calibration,
        # and it's fast enough that CoT stays cheap).
