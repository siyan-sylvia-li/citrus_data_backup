...
DialogueAct = Literal['Think Aloud', 'Conversational Acknowledgment', 'Knowledge Deficit Question', 'Misconception', 'Common Ground Question', 'Vague Answer', 'Partial Answer', 'Social Coordination Action', 'Metacomment', 'Read Aloud', 'Forced Choice', 'Repetition', 'Prompt', 'Solution Request']
...
- "Forced Choice": offers the assistant an explicit small set of options to pick among. E.g. "column 3 or column 4?".
Do NOT use "Prompt" (which is a tutor eliciting from a student) for a user asking the assistant for the move — use "Solution Request"."""
...
class DialogueActSuite(dspy.Module):
    def __init__(self, arbiter=None, callbacks=None, lm_timeout=120, wall_timeout=150):
        ...
        # timeouts and a bigger panel (Gemma was too slow for the real-time
        # prompt gate, but it's fine here).
        specs = {
